...
def process(messages):
	...
	def storeDFtoTable(df, conn, table):		#could not have done this without this resource:
	...
	def messageTransformer(messages):
		print("messageTransformer, message[0]")
		print(messages[0])
	...
	if(len(data) > 0):
		print("num transformed messages = ", len(data))

	#create dataframes
	(breadCrumbs, trips) = createDataFrames(data)
	# print("breadCrumbs:")		
	# print(breadCrumbs.shape)
	# print("trips:")
	# print(trips.shape)
